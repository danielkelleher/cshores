...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <main>
            <div class="container">
                <img src="/images/gallery/landmark/landmark-1.jpg" class="img-responsive br2 mb20" alt="Image">
                ...
                <div class="row image-gallery">
                    ...
                    <div class="col-md-3 col-sm-6 mt20 mb20">
                        <a href="/images/gallery/landmark/landmark-2.jpg">
                            <img src="/images/gallery/landmark/landmark-2.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                    <!-- ITEM -->
                    <div class="col-md-3 col-sm-6 mt20 mb20">
                        <a href="/images/gallery/landmark/landmark-3.jpg">
                            <img src="/images/gallery/landmark/landmark-3.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                    <!-- ITEM -->
                    <div class="col-md-3 col-sm-6 mt20 mb20">
                        <a href="/images/gallery/landmark/landmark-4.jpg">
                            <img src="/images/gallery/landmark/landmark-4.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                    <!-- ITEM -->
                    <div class="col-md-3 col-sm-6 mt20 mb20">
                        <a href="/images/gallery/landmark/landmark-5.jpg">
                            <img src="/images/gallery/landmark/landmark-5.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                </div>
