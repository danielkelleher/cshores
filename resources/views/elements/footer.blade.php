                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 widget">
                            <div class="about">
                                <a href="{{ env('APP_URL') }}"><center><img class="logo" src="{{ env('APP_URL') }}/images/logo-dark.png" height="150px" alt="Logo"></center></a>
                                <p>Located in sunny South Florida, Caribbean Shores aims to provide a tranquil, relaxing, and affordable vacation to those who want to get away for a day, week, or even a few months.</p>
