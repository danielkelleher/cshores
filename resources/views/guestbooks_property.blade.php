        ...
        <div class="page_title gradient_overlay" style="background: url(images/page_title_bg.jpg);">
            <div class="container">
                <div class="inner"> @foreach($property as $prop)
                    <h1>{{$prop->property_name}} Guestbook</h1>
                    <ol class="breadcrumb">
                        <li><a href="/">Home</a></li>
                       ...
                       @foreach($guestbooks as $guestbook)
                            ...
                            <div class="review_item">
                                ...
                                <div class="review_author">
                                    <img src="{{ env('APP_URL') }}/images/users/user3.jpg" alt="Image">
                                ...
                                <div class="vbf">
                                    ...
                                    <form id="guestbook" class="inner">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" name="guestbook-property" value="{{$prop->id}}" type="hidden">
                                        </div>
                                        @endforeach
