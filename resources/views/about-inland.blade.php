...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <main>
            <div class="container">
                <img src="/images/gallery/inland-resort/Inland Resort-1.JPG" class="img-responsive br2 mb20" alt="Image">
                ...
                <div class="row image-gallery">
                    ...
                    <div class="col-md-3 col-sm-6 mt20 mb20">
                        <a href="/images/gallery/inland-resort/Inland Resort-1.JPG">
                            <img src="/images/gallery/inland-resort/Inland Resort-1.JPG" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                    <!-- ITEM -->
                    <div class="col-md-3 col-sm-6 mt20 mb20">
